...
Don't worry, experiment, test things, read the documentation. If anything goes wrong, just delete your `vagrant-spark-zeppelin` folder locally and pull it again from your fork on Github.
